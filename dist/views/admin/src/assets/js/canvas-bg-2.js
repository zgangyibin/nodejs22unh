...
function canvasBg() {
	...
	var ctxfr = ctx.getContext('2d');

	// min and max radius, radius threshold and percentage of filled circles
	var radMin = 5,
	    radMax = 125,
	    filledCircle = 60,
	    //percentage of filled circles
	concentricCircle = 30,
	    //percentage of concentric circles
	...
	for (var i = 0; i < maxCircles * 2; i++) {
		...
		pointsBack.push(new Circle(true));
	} //experimental vars
	var circleExp = 1,
	    circleExpMax = 1.003,
	    circleExpMin = 0.997,
...
//# sourceMappingURL=canvas-bg-2.js.map