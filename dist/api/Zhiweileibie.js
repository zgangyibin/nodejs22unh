...
var _ZhiweileibieModel = require('../models/ZhiweileibieModel');

var _ZhiweileibieModel2 = _interopRequireDefault(_ZhiweileibieModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, zhiweileibie, result;
			return _regenerator2.default.wrap(function _callee$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							_context.prev = 0;
							page = parseInt(req.query.page) || 1; //页

							limit = parseInt(req.query.limit) || 10; //每页数据

							sort = req.query.sort || 'id'; //排序参考

							order = req.query.order || 'asc'; //升序
							...
							_context.next = 10;
							return _ZhiweileibieModel2.default.findAndCountAll({ //会查出列表记录,同时返回符合查询列表数据的条数
								order: [[sort, order]],
								where: where,
				...
				while (1) {
					switch (_context2.prev = _context2.next) {
						case 0:
							...
							_context2.next = 10;
							return _ZhiweileibieModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 4;
							return _ZhiweileibieModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _ZhiweileibieModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _ZhiweileibieModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _ZhiweileibieModel2.default.findOne({ where: { id: req.params.id } });
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM zhiweileibie WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
...
//# sourceMappingURL=Zhiweileibie.js.map