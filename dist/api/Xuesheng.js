...
var _XueshengModel = require('../models/XueshengModel');

var _XueshengModel2 = _interopRequireDefault(_XueshengModel);
...
exports.default = function (_ref) {
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							_context.next = 4;
							return _XueshengModel2.default.findOne({ where: { xuehao: req.query.username, mima: pwd } });
						...
						case 8:
							token = _jsonwebtoken2.default.sign( //生成token
							{
				...
				while (1) {
					switch (_context2.prev = _context2.next) {
						case 0:
							...
							_context2.next = 4;
							return _XueshengModel2.default.create(req.body);
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.t1 = res;
							_context3.next = 5;
							return _XueshengModel2.default.findOne({ where: { id: req.session.userinfo === undefined ? _jsonwebtoken2.default.decode(req.headers.token).id : req.session.userinfo.id } });
				...
				while (1) {
					switch (_context4.prev = _context4.next) {
						case 0:
							...
							pwd = '123456';
							_context4.next = 4;
							return _XueshengModel2.default.update({
								mima: pwd
							}, {
								where: {
	...
	api.get('/page', function () {
		var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(req, res) {
			var page, limit, sort, order, where, xuehao, mima, xueshengxingming, touxiang, xingbie, shoujihaoma, youxiang, result;
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							...
							_context5.next = 22;
							return _XueshengModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(req, res) {
			var page, limit, sort, order, where, xuehao, xueshengxingming, result;
				...
				while (1) {
					switch (_context9.prev = _context9.next) {
						case 0:
							_context9.prev = 0;
							_context9.next = 3;
							return _XueshengModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context10.prev = _context10.next) {
						case 0:
							_context10.prev = 0;
							_context10.next = 3;
							return _XueshengModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context11.prev = _context11.next) {
						case 0:
							...
							_context11.t1 = res;
							_context11.next = 5;
							return _XueshengModel2.default.findOne({ where: { id: req.params.id } });
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM xuesheng WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
...
//# sourceMappingURL=Xuesheng.js.map