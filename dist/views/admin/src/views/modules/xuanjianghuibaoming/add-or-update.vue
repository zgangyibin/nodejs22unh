	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="举办会场" prop="jubanhuichang">
					<el-input v-model="ruleForm.jubanhuichang" placeholder="举办会场" clearable  :readonly="ro.jubanhuichang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="举办会场" prop="jubanhuichang">
					<el-input v-model="ruleForm.jubanhuichang" placeholder="举办会场" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="举办时间" prop="jubanshijian">
					<el-input v-model="ruleForm.jubanshijian" placeholder="举办时间" clearable  :readonly="ro.jubanshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="举办时间" prop="jubanshijian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="报名时间" prop="baomingshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.baomingshijian" label="报名时间" prop="baomingshijian">
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jubanhuichang'){
							this.ruleForm.jubanhuichang = obj[o];
							this.ro.jubanhuichang = true;
							continue;
						}
						if(o=='jubanshijian'){
    ...
    info(id) {
      this.$http({
        url: `xuanjianghuibaoming/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xuanjianghuibaoming/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xuanjianghuibaomingCrossAddOrUpdateFlag = false;
						 this.parent.search();
