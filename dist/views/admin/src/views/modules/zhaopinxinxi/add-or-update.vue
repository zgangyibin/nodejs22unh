	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="职位类别" prop="zhiweileibie">
					<el-select :disabled="ro.zhiweileibie" v-model="ruleForm.zhiweileibie" placeholder="请选择职位类别" >
						<el-option
							v-for="(item,index) in zhiweileibieOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="职位类别" prop="zhiweileibie">
					<el-input v-model="ruleForm.zhiweileibie"
						placeholder="职位类别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="招聘人数" prop="zhaopinrenshu">
					<el-input v-model="ruleForm.zhaopinrenshu" placeholder="招聘人数" clearable  :readonly="ro.zhaopinrenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="招聘人数" prop="zhaopinrenshu">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="工作详情" prop="gongzuoxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.gongzuoxiangqing" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.gongzuoxiangqing" label="工作详情" prop="gongzuoxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"rgba(90, 67, 74, 1)","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.gongzuoxiangqing"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='gongzuoxiangqing'){
							this.ruleForm.gongzuoxiangqing = obj[o];
							this.ro.gongzuoxiangqing = true;
							continue;
						}
						if(o=='fabushijian'){
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(json.qiyedizhi!=''&&json.qiyedizhi && this.$storage.get("role")!="管理员"){
            ...
            this.$http({
				...
				if (data && data.code === 0) {
					this.zhiweileibieOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
	...
	this.ruleForm.gongzuoxiangqing = this.ruleForm.gongzuoxiangqing.replace(reg,'../../../nodejs22unh/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
