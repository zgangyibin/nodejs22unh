	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="就业企业" prop="jiuyeqiye">
					<el-input v-model="ruleForm.jiuyeqiye" placeholder="就业企业" clearable  :readonly="ro.jiuyeqiye"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="就业企业" prop="jiuyeqiye">
					<el-input v-model="ruleForm.jiuyeqiye" placeholder="就业企业" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="就业岗位" prop="jiuyegangwei">
					<el-input v-model="ruleForm.jiuyegangwei" placeholder="就业岗位" clearable  :readonly="ro.jiuyegangwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="就业岗位" prop="jiuyegangwei">
					<el-input v-model="ruleForm.jiuyegangwei" placeholder="就业岗位" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="就业日期" prop="jiuyeriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.jiuyeriqi" 
						type="date"
						:readonly="ro.jiuyeriqi"
						placeholder="就业日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jiuyeriqi" label="就业日期" prop="jiuyeriqi">
					<el-input v-model="ruleForm.jiuyeriqi" placeholder="就业日期" readonly></el-input>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				jiuyeqiye: [
					{ required: true, message: '就业企业不能为空', trigger: 'blur' },
				],
				jiuyegangwei: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiuyeqiye'){
							this.ruleForm.jiuyeqiye = obj[o];
							this.ro.jiuyeqiye = true;
							continue;
						}
						if(o=='jiuyegangwei'){
							this.ruleForm.jiuyegangwei = obj[o];
							this.ro.jiuyegangwei = true;
							continue;
						}
						if(o=='qiyedizhi'){
						...
						if(o=='jiuyeriqi'){
							this.ruleForm.jiuyeriqi = obj[o];
							this.ro.jiuyeriqi = true;
							continue;
						}
						if(o=='beizhu'){
