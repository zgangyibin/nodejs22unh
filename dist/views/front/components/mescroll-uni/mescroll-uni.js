...
MeScroll.extend = function (userOption, defaultOption) {
	...
	for (var key in defaultOption) {
		if (userOption[key] == null) {
			...
			if (def != null && (typeof def === 'undefined' ? 'undefined' : (0, _typeof3.default)(def)) === 'object') {
				userOption[key] = MeScroll.extend({}, def); // 深度匹配
			} else {
				userOption[key] = def;
			}
		} else if ((0, _typeof3.default)(userOption[key]) === 'object') {
...
MeScroll.prototype.endSuccess = function (dataSize, hasNext, systime) {
	...
	// 结束上拉加载
	if (me.optUp.use) {
		var isShowNoMore = void 0; // 是否已无更多数据
		if (dataSize != null) {
...
//# sourceMappingURL=mescroll-uni.js.map