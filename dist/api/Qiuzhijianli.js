...
var _QiuzhijianliModel = require('../models/QiuzhijianliModel');

var _QiuzhijianliModel2 = _interopRequireDefault(_QiuzhijianliModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, xuehao, xueshengxingming, touxiang, xingbie, nianling, zhuanye, xueli, biyeyuanxiao, waiyushuiping, qiuzhiyixiang, qiwangxinzi, shehuishijian, gerenjianjie, userid, tableName, result;
						...
						case 0:
							...
							if (nianling) {
								...
								if (nianling.indexOf('%') != -1) {
									where.nianling = (0, _defineProperty3.default)({}, _sequelize.Op.like, nianling);
								} else {
									where.nianling = (0, _defineProperty3.default)({}, _sequelize.Op.eq, nianling);
								}
							}
							...
							xueli = req.query.xueli;

							if (xueli) {

								if (xueli.indexOf('%') != -1) {
									where.xueli = (0, _defineProperty3.default)({}, _sequelize.Op.like, xueli);
								} else {
									where.xueli = (0, _defineProperty3.default)({}, _sequelize.Op.eq, xueli);
								}
							}
							biyeyuanxiao = req.query.biyeyuanxiao;

							if (biyeyuanxiao) {

								if (biyeyuanxiao.indexOf('%') != -1) {
									where.biyeyuanxiao = (0, _defineProperty3.default)({}, _sequelize.Op.like, biyeyuanxiao);
								} else {
									where.biyeyuanxiao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, biyeyuanxiao);
								}
							}
							waiyushuiping = req.query.waiyushuiping;

							if (waiyushuiping) {

								if (waiyushuiping.indexOf('%') != -1) {
									where.waiyushuiping = (0, _defineProperty3.default)({}, _sequelize.Op.like, waiyushuiping);
								} else {
									where.waiyushuiping = (0, _defineProperty3.default)({}, _sequelize.Op.eq, waiyushuiping);
								}
							}
							qiuzhiyixiang = req.query.qiuzhiyixiang;

							if (qiuzhiyixiang) {

								if (qiuzhiyixiang.indexOf('%') != -1) {
									where.qiuzhiyixiang = (0, _defineProperty3.default)({}, _sequelize.Op.like, qiuzhiyixiang);
								} else {
									where.qiuzhiyixiang = (0, _defineProperty3.default)({}, _sequelize.Op.eq, qiuzhiyixiang);
								}
							}
							qiwangxinzi = req.query.qiwangxinzi;

							if (qiwangxinzi) {

								if (qiwangxinzi.indexOf('%') != -1) {
									where.qiwangxinzi = (0, _defineProperty3.default)({}, _sequelize.Op.like, qiwangxinzi);
								} else {
									where.qiwangxinzi = (0, _defineProperty3.default)({}, _sequelize.Op.eq, qiwangxinzi);
								}
							}
							shehuishijian = req.query.shehuishijian;

							if (shehuishijian) {

								if (shehuishijian.indexOf('%') != -1) {
									where.shehuishijian = (0, _defineProperty3.default)({}, _sequelize.Op.like, shehuishijian);
								} else {
									where.shehuishijian = (0, _defineProperty3.default)({}, _sequelize.Op.eq, shehuishijian);
								}
							}
							gerenjianjie = req.query.gerenjianjie;

							if (gerenjianjie) {

								if (gerenjianjie.indexOf('%') != -1) {
									where.gerenjianjie = (0, _defineProperty3.default)({}, _sequelize.Op.like, gerenjianjie);
								} else {
									where.gerenjianjie = (0, _defineProperty3.default)({}, _sequelize.Op.eq, gerenjianjie);
								}
							}
							...
							_context.next = 38;
							return _QiuzhijianliModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, xueshengxingming, zhuanye, qiuzhiyixiang, tableName, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 5;
							return _QiuzhijianliModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _QiuzhijianliModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _QiuzhijianliModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _QiuzhijianliModel2.default.findOne({ where: { id: req.params.id } });
					...
					switch (_context9.prev = _context9.next) {
						case 0:
							...
							if (req.params.type == 1) {
								if (req.query.remindstart) sql = "SELECT COUNT(*) AS count FROM qiuzhijianli WHERE " + req.params.columnName + " >= '" + req.query.remindstart + "'";
								if (req.query.remindend) sql = "SELECT COUNT(*) AS count FROM qiuzhijianli WHERE " + req.params.columnName + " <= '" + req.query.remindend + "'";

								if (req.query.remindstart && req.query.remindend) {
									sql = "SELECT COUNT(*) AS count FROM qiuzhijianli WHERE " + req.params.columnName + " >= '" + req.query.remindstart + "' AND " + req.params.columnName + " <= '" + req.query.remindend + "'";
								}
							}
							...
							if (req.params.type == 2) {
								if (req.query.remindstart) {
									...
									sql = "SELECT COUNT(*) AS count FROM qiuzhijianli WHERE " + req.params.columnName + " >= '" + remindStart + "'";
								}
								if (req.query.remindend) {
									remindEnd = _util2.default.getDateTimeFormat(req.query.remindend, "yyyy-MM-dd");

									sql = "SELECT COUNT(*) AS count FROM qiuzhijianli WHERE " + req.params.columnName + " <= '" + remindEnd + "'";
								}
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM qiuzhijianli WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
				...
				while (1) {
					switch (_context10.prev = _context10.next) {
						case 0:
							...
							sql = "SELECT COUNT(*) AS total, " + columnName + " FROM qiuzhijianli " + where + " GROUP BY " + columnName + " LIMIT 10";
				...
				while (1) {
					switch (_context11.prev = _context11.next) {
						case 0:
							...
							sql = "SELECT " + xColumnName + ", SUM(" + yColumnName + ") AS total FROM qiuzhijianli " + where + " GROUP BY " + xColumnName + " DESC LIMIT 10";
...
//# sourceMappingURL=Qiuzhijianli.js.map